...
export default async function handler(req,res){
  ...
  try{
    const compact=questions.map(q=>({id:q.id,type:q.type,text:q.text,choices:q.choices||null}));
...
Do not change scientific meaning, difficulty, IDs, question type, or question intent.
For True/False use "صح" and "خطأ".
Return strict JSON only:
{"questions":[{"id":"...","text":"...","choices":["..."] or null}]}`,
