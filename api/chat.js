...
export default async function handler(req,res){
  ...
  try{
    ...
    const inScope=safeSubject==='P4 Arabic'?true:await isInCurriculum({
      apiKey,
      question,
      lesson,
...
مهم جدًا: التزم بمنهج ${safeSubject} والترم الحالي. في P4 Arabic تحديدًا، اعتبر مرجع المنهج الكامل المرسل مع الطلب مرجعك التعليمي الأساسي. استخدم أسماء الدروس والقواعد والمفاهيم والمفردات الموجودة فيه لفهم السؤال والإجابة عنه حتى لو كان من فرع آخر غير الجزء المفتوح حاليًا. الفروع المعتمدة هي الاستماع والقراءة والنحو والتحدث والنصوص والبلاغة، مع استبعاد التعبير الكتابي والإملاء والخط. لا تعتبر السؤال خارج المنهج لمجرد اختلاف الصياغة أو اختلاف الجزء المفتوح.
