...
مهم جدًا: التزم بمنهج ${safeSubject} والترم الحالي. في P4 Arabic تحديدًا، الفروع المعتمدة هي الاستماع والقراءة والنحو والتحدث والنصوص والبلاغة، مع استبعاد التعبير الكتابي والإملاء والخط. إذا كان سؤال الطالب متعلقًا بأي نحو أو نص أو بلاغة أو قراءة أو استماع أو تحدث موجود في منهج رابعة الترم الأول فأجب مباشرة، حتى لو كان الجزء المفتوح حاليًا في الواجهة جزءًا آخر. لا تعتبره خارج المنهج بسبب اختلاف عنوان الجزء.
